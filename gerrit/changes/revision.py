...
class GerritChangeRevision:
    ...
    def get_merge_list(self) -> List[Dict[str, Any]]:
        """
    ...
    def get_revision_actions(self) -> Dict[str, Any]:
        """
    ...
    def get_related_changes(self) -> Dict[str, Any]:
        """
    ...
    def set_review(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def get_patch(self, zip_: bool = False, download: bool = False, path: Optional[str] = None, decode: bool = False) -> str:
        """
    ...
    def is_mergeable(self) -> Dict[str, Any]:
        """
    ...
    def test_submit_type(self, input_: str) -> str:
        """
    ...
    def test_submit_rule(self, input_: str) -> List[Dict[str, Any]]:
        """
    ...
    def get_robot_comment(self, commit_id: str) -> Dict[str, Any]:
        """
