...
class GerritChangeRevisionFile:
    ...
    def get_content(self, decode: bool = False) -> str:
        """
    ...
    def get_diff(self, intraline: bool = False) -> Dict[str, Any]:
        """
    ...
    def get_blame(self) -> List[Dict[str, Any]]:
        """
...
class GerritChangeRevisionFiles:
    ...
    def __iter__(self) -> Iterator["GerritChangeRevisionFile"]:
        """
    ...
    def __getitem__(self, path: str) -> "GerritChangeRevisionFile":
        """
        get a file by path
    ...
    def get(self, path: str) -> "GerritChangeRevisionFile":
        """
        get a file by path
