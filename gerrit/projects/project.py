...
class GerritProject(GerritBase):
    def __init__(self, project_id: str, gerrit: GerritClient) -> None:
        self.id = project_id
        self.gerrit = gerrit
    ...
    def set_parent(self, input_: Dict[str, Any]) -> str:
        """
    ...
    def set_head(self, input_: Dict[str, Any]) -> str:
        """
    ...
    def set_config(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def run_garbage_collection(self, input_: Dict[str, Any]) -> str:
        """
    ...
    def ban_commits(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def get_access_rights(self) -> Dict[str, Any]:
        """
    ...
    def set_access_rights(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def create_change(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def create_access_rights_change(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
        Sets access rights for the project using the diff schema provided by ProjectAccessInput
    ...
    def check_access(self, options: str) -> Dict[str, Any]:
        """
    ...
    def index(self, input_: Dict[str, Any]) -> None:
        """
    ...
    def index_all_changes(self) -> None:
        """
        Adds or updates the current project (and children, if specified) in the secondary index.
        The indexing task is executed asynchronously in background and this command returns
        immediately if async is specified in the input.
    ...
    def check_consistency(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def get_commit(self, commit: str) -> "GerritProjectCommit":
        """
