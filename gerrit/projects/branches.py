...
class GerritProjectBranch(GerritBase):
    ...
    def is_mergeable(self, input_: Dict[str, Any]) -> Any:
        """
...
class GerritProjectBranches:
    ...
    def list(self, pattern_dispatcher: Optional[Dict[str, Any]] = None, limit: int = 25, skip: int = 0) -> List[Any]:
        """
    ...
    def delete_branches(self, input_: Dict[str, Any]) -> None:
        """
