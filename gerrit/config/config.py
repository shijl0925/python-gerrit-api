...
class GerritConfig:
    ...
    def confirm_email(self, input_: Dict[str, Any]) -> None:
        """
    ...
    def get_summary(self, option: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def get_top_menus(self) -> List[Dict[str, Any]]:
        """
    ...
    def get_default_user_preferences(self) -> Dict[str, Any]:
        """
    ...
    def set_default_user_preferences(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def get_default_diff_preferences(self) -> Dict[str, Any]:
        """
    ...
    def set_default_diff_preferences(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def get_default_edit_preferences(self) -> Dict[str, Any]:
        """
    ...
    def set_default_edit_preferences(self, input_: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def index_changes(self, input_: Dict[str, Any]) -> None:
        """
