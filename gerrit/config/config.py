...
class GerritConfig:
    ...
    def get_summary(self, option: Optional[str] = None) -> Any:
        """
    ...
    def set_default_user_preferences(self, input_: Dict[str, Any]) -> Any:
        """
    ...
    def set_default_diff_preferences(self, input_: Dict[str, Any]) -> Any:
        """
    ...
    def set_default_edit_preferences(self, input_: Dict[str, Any]) -> Any:
        """
